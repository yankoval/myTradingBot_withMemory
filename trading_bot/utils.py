...
def calcLevels(df, kMeansKwargs={"init": "k-means++", "n_init": 4, "n_clusters": 20}, type='futures', MINSTEP=25,
               DECIMALS=2):
...
def readData(stock_file: str, dataPath: str, *agrs, tfCounts=None, tik=None, tFrame='daily', dFrom=None, dTo=None,
             skiprows=range(1, 1), nrows=None, **kwargs):
    """Reads stock data from csv file if stock_file specified else read from finam csv db
    """
